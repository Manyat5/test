 ...
 * of modes. Users may select the default benchmark mode with JMHSample_08_DeadCode.txt special
...
public class JMHSample_02_BenchmarkModes {
     ...
     * continuously calling the benchmark method in JMHSample_08_DeadCode.txt time-bound iteration, and
     ...
     * still running the method in JMHSample_08_DeadCode.txt time-bound iteration, but instead of
     ...
     * above can be replaced with just JMHSample_08_DeadCode.txt single test like this:
     */
    @Benchmark
     ...
     *    (we requested JMHSample_08_DeadCode.txt single fork; there are also other options, see -h)
     *
     * b) Via the Java API:
